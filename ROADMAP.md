...
- [x] Confidence intervals for behavioral metrics — [#115](https://github.com/askmy-stack/tool-semantics/issues/115) **P3**
- [ ] Dev / test / verified split — [#116](https://github.com/askmy-stack/tool-semantics/issues/116) **P3**
